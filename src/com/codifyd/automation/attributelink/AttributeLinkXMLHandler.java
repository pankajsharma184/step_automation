...
public class AttributeLinkXMLHandler {
		...
		try {
			...
			for (String key : set) {
				...
				for (AttributeLinkExcelInfo info : list) {
					...
					if (toBoolean(info.getMandatory())) {
	...
	public static void readExcel(File file, TreeMap<String, ArrayList<AttributeLinkExcelInfo>> excelinfo) {
		try {
