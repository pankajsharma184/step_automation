 ...
 *             
 * 
 * <p>Java class for ClassificationsType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Classification" type="{http://www.stibosystems.com/step}ClassificationType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="RejectNewClassifications" type="{http://www.stibosystems.com/step}TrueFalseType" default="false" />
...
public class ClassificationsType {
    ...
    @XmlAttribute(name = "RejectNewClassifications")
    protected TrueFalseType rejectNewClassifications;
    ...
    /**
     * Gets the value of the rejectNewClassifications property.
     * 
     * @return
     *     possible object is
     *     {@link TrueFalseType }
     *     
     */
    public TrueFalseType getRejectNewClassifications() {
        if (rejectNewClassifications == null) {
            return TrueFalseType.FALSE;
        } else {
            return rejectNewClassifications;
        }
    }

    /**
     * Sets the value of the rejectNewClassifications property.
     * 
     * @param value
     *     allowed object is
     *     {@link TrueFalseType }
     *     
     */
    public void setRejectNewClassifications(TrueFalseType value) {
        this.rejectNewClassifications = value;
    }
